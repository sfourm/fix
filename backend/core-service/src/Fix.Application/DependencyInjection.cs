...
public static class DependencyInjection
{
    ...
    private const string UseCaseInterfacesNamespace = "Fix.Application.Common.Interfaces.UseCases";
    ...
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<OrgChartApproval>();
        services.AddScoped<InternalAccess>();
    ...
    /// <summary>
    /// Registra cada service da Application pela sua interface (PolicyService → IPolicyService), embrulhado
    /// pelo <see cref="UseCaseGuardProxy{TService}"/>, que aplica contexto e autorização antes de cada caso de uso.
    /// </summary>
