...
const orders: DataSourceDefinition<OrderResponse> = {
  ...
  role: 'view_order',
  fields: [
    dim('code', 'Boleta', 'text', (o) => o.code),
    dim('approval', 'Aprovação', 'enum', (o) => o.approval, { options: optionLabels.approval }),
    dim('compliance', 'Enquadramento', 'enum', (o) => o.compliance.status, { options: optionLabels.compliance }),
    dim('withoutMandate', 'Sem mandato', 'boolean', (o) => o.mandateId === null),
    dim('linkedAfterExecution', 'Vínculo a posteriori', 'boolean', (o) => o.linkedAfterExecution),
    dim('exceedsMandate', 'Estourou o mandato', 'boolean', (o) => o.exceedsMandate),
    dim('confirmation', 'Confirmação', 'enum', (o) => o.confirmation, { options: optionLabels.confirmation }),
    ...
    dim('mandateCode', 'Mandato (código)', 'text', (o) => o.mandateCode),
    dim('mandateTitle', 'Mandato', 'text', (o) => o.mandateTitle),
    dim('tenor', 'Tela / vencimento', 'text', (o) => o.terms.tenor),
    dim('tradeDate', 'Data da operação', 'date', (o) => o.terms.tradeDate, { groupable: false }),
    dim('tradeMonth', 'Mês da operação', 'text', (o) => month(o.terms.tradeDate), { format: 'month' }),
    dim('confirmationOverdue', 'Confirmação atrasada', 'boolean', (o) => o.confirmationOverdue),
...
const mandates: DataSourceDefinition<MandateResponse> = {
  ...
  role: 'view_mandate',
  fields: [
    dim('code', 'Mandato', 'text', (m) => m.code),
